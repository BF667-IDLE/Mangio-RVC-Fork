...
## Or Manually
```bash
python web.py --pycmd python --is_cli
```
## Usage
```bash
...
<a href="https://github.com/BF667-IDLE/Mangio-RVC-Fork/graphs/contributors" target="_blank">
  <img src="https://contrib.rocks/image?repo=BF667-IDLE/Mangio-RVC-Fork" />
</a>
